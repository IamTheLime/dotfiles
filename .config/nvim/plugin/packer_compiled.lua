...
_G.packer_plugins = {
  ...
  ["fine-cmdline.nvim"] = {
    loaded = true,
    path = "/home/tiago/.local/share/nvim/site/pack/packer/start/fine-cmdline.nvim",
  ...
  ["lsp_signature.nvim"] = {
    loaded = true,
    path = "/home/tiago/.local/share/nvim/site/pack/packer/start/lsp_signature.nvim",
  ...
  neogit = {
    loaded = true,
    path = "/home/tiago/.local/share/nvim/site/pack/packer/start/neogit",
  ...
  ["nvim-dap-ui"] = {
    loaded = true,
    path = "/home/tiago/.local/share/nvim/site/pack/packer/start/nvim-dap-ui",
