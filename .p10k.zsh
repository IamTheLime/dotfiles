# Generated by Powerlevel10k configuration wizard on 2022-02-14 at 11:28 GMT.
...
() {
  ...
  typeset -g POWERLEVEL9K_VIRTUALENV_GENERIC_NAMES=(virtualenv venv .venv env .local) 
  # Custom icon.
