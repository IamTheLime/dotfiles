...
if [ "$P9K_CONTENT" = "" ]; then git clone --depth=1 https://github.com/romkatv/powerlevel10k.git ${ZSH_CUSTOM:-$HOME/.oh-my-zsh/custom}/themes/powerlevel10k; fi
...
#repos() {
#    cd "${WHATEVER_DIR_WE_DEFINE}/$1"
#}
#_repos() {
#    # this is one way of defining completion by directory, where 
#    ((CURRENT == 2)) && _files -/ -W ${WHATEVER_DIR_WE_DEFINE}
#}
...
#
#
plugins=(git poetry ripgrep virtualenv zsh-autosuggestions fzf-tab zsh-syntax-highlighting ssh-agent)
